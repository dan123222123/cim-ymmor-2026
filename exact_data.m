...
N = 30; x = linspace(-7.5,0,N); y = linspace(-5,5,N); [X,Y] = meshgrid(x,y); G = X + 1i*Y;
...
%% singular value decay of ERA and SPLoewner Db -- MATLAB preview (default).
% ERA (sigma = Inf)
...
%   exact_svd.dat       -- columns k, era, spl (space-separated)
%   exact_svd_meta.tex  -- defines \ExactSvdSplLabel with sigma_best
%{
